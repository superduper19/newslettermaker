...
function getInspirationalRemotePath() {
    return {
        remoteDir: process.env.GODADDY_INSPIRATIONAL_FTP_PATH || 'inspirational',
        publicUrlBase: process.env.GODADDY_INSPIRATIONAL_PUBLIC_BASE_URL || `${getPublicBaseUrl()}/${getInspirationalSubfolder()}`
    };
}
